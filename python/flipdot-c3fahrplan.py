...
#writeText("A Tale of", [0, 0])
#writeText("Two Leaks:", [0, 9])
#writeText("How Hackers", [0, 2*9])
#writeText("Breached the", [0, 3*9])
#writeText("Great Firewall", [0, 4*9])
#writeText("of China", [0, 5*9])
...
writeText("And so it begins", [0, 0])
writeText(" - Wie unser", [0, 9])
writeText("Rechtsstaat auf", [0, 2*9])
writeText("dem Highway", [0, 3*9])
writeText("Richtung Trump-", [0, 4*9])
writeText("ismus rast", [0, 5*9])
